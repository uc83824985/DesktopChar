...
if (process.argv[1] && import.meta.url === pathToFileURL(process.argv[1]).href) {
  const defaultRate = environmentRate(process.env.DESKTOP_CHAR_TTS_LOCAL_RATE, 1);
  ...
  console.log(`[local-tts-mcp] voices jrpg-blip (default), jrpg-blip-varied; default rate ${defaultRate}x`);
